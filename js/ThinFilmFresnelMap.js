...
export class ThinFilmFresnelMap extends DataTexture {

  constructor(filmThickness=380.0, refractiveIndexFilm=2, refractiveIndexBase=3, size=64) {

      const data = new Uint8Array(size * 4);
      super(data, size, 1, RGBAFormat, UnsignedByteType, UVMapping, RepeatWrapping, RepeatWrapping, LinearFilter, LinearMipMapLinearFilter);
